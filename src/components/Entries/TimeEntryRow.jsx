...
export default function TimeEntryRow({ entry, projects, onContinue, onDelete, onUpdate }) {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Duration */}
        <div className="text-sm font-medium text-gray-700 font-mono min-w-20 text-right">
